        ...
        <form on:submit|preventDefault={signup}>
            ...
            <div class="mt-6">
                <button
                    ...
                    type="submit"
                    class="flex items-center mx-auto mt-4 py-4 px-16 font-bold text-lg btn variant-filled rounded-xl text-white hover:text-gray-900 hover:bg-white focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed">
